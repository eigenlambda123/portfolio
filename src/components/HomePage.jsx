      ...
      <section className="hero" id="top">
        <div className="hero-inner">
          <div>
            ...
            <h1>RM A. Villa</h1>
            <p className="lead">
              Hi! I’m RM, a computer science student exploring research, software, and AI to make a meaningful impact. 
            </p>
